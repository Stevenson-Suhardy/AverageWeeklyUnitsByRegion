...
namespace AverageWeeklyUnitsByRegion
{
    public partial class formAverageWeeklyUnitsByRegion : Form
    {
            ...
            if (ValidateInput(textBoxCases))
            {
                ...
                if (currentRegion == region1Index)
                {
                    ...
                    if (currentDay == maxDayIndex)
                    {
                        ...
                        // Adding the new updated region1 label
                        ...
                        // Adding the new updated region2 label
        ...
        private void ResetForm()
        {
            ...
            region3Average = 0;
            totalAverage = 0;
            // Adjusting the bold labels by removing and adding new updated labels again (because I do not know how to do it any other way sadly)
            this.Controls.Remove(region1);
            this.Controls.Remove(region2);
            this.Controls.Remove(region3);
            region1 = new Label
            ...
            // Adding the new labels to the form
            this.Controls.Add(region1);
            this.Controls.Add(region2);
            this.Controls.Add(region3);
